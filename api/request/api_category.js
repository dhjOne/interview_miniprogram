...
export const categoryApi = {
  ...
  getCategories: (categoryParams, options = {}) => {
    ...
    const url = scope === 'career' ? '/repository/category/career' : '/repository/category';
  ...
  getQuestions: (categoryParams, options = {}) =>
    http.get('/repository/questions', categoryParams, {
      showLoading: false,
      skipEnsureSession: true,
      ...options,
    }),
  ...
  suggestCategory: (suggestParams, options = {}) =>
    http.post('/repository/categories/suggest', suggestParams, {
      showLoading: false,
      ...options,
    }),
};
